...
export const HAIR_STYLE_CATALOG = [
  { id: 'textured-crop', name: 'Textured Crop', category: 'haircut', description: 'Short textured top with a clean tapered perimeter.' },
  { id: 'low-taper', name: 'Low Taper', category: 'haircut', description: 'A subtle taper that keeps natural weight through the sides.' },
  { id: 'mid-fade', name: 'Mid Fade', category: 'haircut', description: 'Balanced fade placement with a crisp transition.' },
  { id: 'burst-fade', name: 'Burst Fade', category: 'haircut', description: 'Rounded fade around the ear with length through the back.' },
  { id: 'classic-pompadour', name: 'Classic Pompadour', category: 'haircut', description: 'Structured volume swept back with tidy sides.' },
  { id: 'curly-shape-up', name: 'Curly Shape Up', category: 'haircut', description: 'Natural curls retained with a precise outline.' },
  { id: 'buzz-cut', name: 'Buzz Cut', category: 'haircut', description: 'Even, close length with a sharp hairline.' },
  { id: 'slick-back', name: 'Slick Back', category: 'haircut', description: 'Longer top directed back with controlled sides.' },
  { id: 'boxed-beard', name: 'Boxed Beard', category: 'beard', description: 'Structured cheek and jaw lines with balanced fullness.' },
  { id: 'short-beard-fade', name: 'Short Beard Fade', category: 'beard', description: 'A close beard blended cleanly into the sideburns.' },
  { id: 'goatee-detail', name: 'Detailed Goatee', category: 'beard', description: 'Focused chin and moustache definition with clean cheeks.' },
  { id: 'warm-brown', name: 'Warm Brown', category: 'color', description: 'Natural warm-brown tone with dimensional variation.' },
  { id: 'platinum-top', name: 'Platinum Top', category: 'color', description: 'Cool platinum tone focused through the top.' },
  { id: 'silver-blend', name: 'Silver Blend', category: 'color', description: 'Soft silver blending that keeps realistic tonal depth.' },
  { id: 'crop-beard-combo', name: 'Crop + Beard Blend', category: 'combo', description: 'Textured crop and beard connected with one continuous fade.' },
  { id: 'pompadour-boxed-beard', name: 'Pompadour + Boxed Beard', category: 'combo', description: 'Polished volume paired with a structured beard.' },
] as const;
