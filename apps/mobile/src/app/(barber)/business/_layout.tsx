 ...
 * icons, and pushing a screen swapped tabs instead of stacking. This keeps Business a single tab that
 * owns its own stack.
 */
export default function BusinessLayout(): React.ReactElement {
