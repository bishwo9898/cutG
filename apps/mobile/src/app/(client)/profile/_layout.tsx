 ...
 * icons, and pushing a screen swapped tabs instead of stacking. This keeps Profile a single tab that
 * owns its own stack.
 */
export default function ClientProfileLayout(): React.ReactElement {
