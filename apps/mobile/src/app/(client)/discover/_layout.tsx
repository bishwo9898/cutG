 ...
 * icons, and pushing a screen swapped tabs instead of stacking. This keeps Discover a single tab that
 * owns its own stack.
 */
export default function DiscoverLayout(): React.ReactElement {
